...
const assistantComponents: Components = {
  ...
  ul: ({ children }) => (
    <ul className="mb-2 flex flex-col gap-0.5 pl-4 list-disc">{children}</ul>
  ),
  ol: ({ children }) => (
    <ol className="mb-2 flex flex-col gap-0.5 pl-4 list-decimal">{children}</ol>
  ),
  ...
  h2: ({ children }) => (
    <h2 className="mb-1.5 text-sm font-semibold">{children}</h2>
  ),
  h3: ({ children }) => (
  ...
  code: ({ className, children }) => {
    ...
    return (
      <code className="font-mono text-[11px] leading-snug">{children}</code>
    );
  },
  pre: ({ children }) => (
...
const workspaceAssistantComponents: Components = {
  p: ({ children }) => (
    <p className="mb-2 last:mb-0 text-[13px] leading-[1.5] text-foreground">
      {children}
    </p>
  ),
  ul: ({ children }) => (
    <ul className="mb-2 flex flex-col gap-1 pl-[1.1em] list-disc">
      {children}
    </ul>
  ),
  ol: ({ children }) => (
    <ol className="mb-2 flex flex-col gap-1 pl-[1.1em] list-decimal">
      {children}
    </ol>
  ),
  li: ({ children }) => (
    <li className="text-[13px] leading-[1.5] text-foreground">{children}</li>
  ),
  h1: ({ children }) => (
  ...
  code: ({ className, children }) => {
    ...
    return (
      <code className="font-mono text-[12px] leading-snug">{children}</code>
    );
  },
  pre: ({ children }) => (
...
const userWorkspaceComponents: Components = {
  ...
  p: ({ children }) => (
    <p className="mb-2 last:mb-0 text-[13px] leading-[1.5] text-background">
      {children}
    </p>
  ),
  li: ({ children }) => (
    <li className="text-[13px] text-background">{children}</li>
  ),
  code: ({ className, children }) => {
    const inline = !className;
    if (inline) {
    ...
    return (
      <code className="font-mono text-[12px] text-background">{children}</code>
    );
  },
  pre: ({ children }) => (
...
export function ChatMarkdown({
  ...
  return (
    <div
      className={
        variant === "workspace"
          ? "assistant-md text-[13px] leading-relaxed"
